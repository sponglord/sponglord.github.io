(function() {
    ...
    adyen.cse = adyen.cse || {};
    adyen.cse.version = "0_1_23";

    adyen.cse.id = "9915408087441342";
    ...
    // CSE Library minified version: 0_1_23
    /*
 *
 ...
 */
    (function(root, fnDefine) {
            ...
            if (document && window && document.getElementsByTagName) {
                ...
                var PluginDetect = {
                    ...
                    initScript: function() {
                        ...
                        if (h) {
                            var b,
                                j = ["Win", 1, "Mac", 2, "Linux", 3, "FreeBSD", 4, "iPhone", 21.1, "iPod", 21.2, "iPad", 21.3, "Win.*CE", 22.1, "Win.*Mobile", 22.2, "Pocket\\s*PC", 22.3, "", 100];
                        ...
                        if (i.isIE) {
                            var b,
                                f = ["Msxml2.XMLHTTP", "Msxml2.DOMDocument", "Microsoft.XMLDOM", "ShockwaveFlash.ShockwaveFlash", "TDCCtl.TDCCtl", "Shell.UIHelper", "Scripting.Dictionary", "wmplayer.ocx"];
                ...
                df = function() {
                    ...
                    setTimeout(function() {
                        ...
                        console.log('CSE dfValue=',dfValue);
                    }, 10);
                    return ""
                }
            } else {
        ...
        var Encryption = function(key, options) {
            ...
            if (options.stopDeviceFingerprint === true) {
                doDeviceFingerprint = false
            }
            if(doDeviceFingerprint){
                console.log('Doing deviceFingerprinting 1st time')
                try {
                    df()
                } catch (e) {}
            }else{
                console.log('Skipping deviceFingerprinting 1st time')
            }
            this.key = key;
        ...
        Encryption.prototype.encrypt = function(original, dfValue) {
            ...
            if(doDeviceFingerprint){
                try {
                    data.dfValue = df()
                    console.log('Doing deviceFingerprinting 2nd time :: dfValue=',dfValue)
                } catch (e) {}
            }else{

                if(dfValue){
                    data.dfValue = dfValue;
                    console.log('Skipping deviceFingerprinting 2nd time :: dfValue=',dfValue)
                }
            }
    ...
    if (typeof adyen.encrypt.createEncryptedForm === "function") {
        (function() {
            var key = "10001|";
