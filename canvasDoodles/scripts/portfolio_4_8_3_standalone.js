function Portfolio_4_8_3_s(mouseContext, aNumImages){
    var _canvas, _context, _image, _images = [], _count = 0, _imageW = 30, _imageH = 30, _numImages = 60, _checkForCollision = true, _gotoTarget = false, _doMove = true, _imgInPlaceCount = 0, _interval, _canvasW, _canvasH;
    ...
    this.init = function(){
		...
		if(aNumImages === undefined){
			this.createTilePositions(_images, 15, 4, 25, 200);
        }
    ...
    //
    // portfolio_4_8_2
    // -- 4 dots with permanent sinuousy lines between them
    //
    // portfolio_4_8_3
    // -- multi sinuous curves only - doesn't stop at end, once in grid, tho' i think this will ultimately kill the processor!
    // -- at this end, grid stage different oscFactor & angleIncr settings in the draw function have some mad effects
    //
...
//  					clearInterval(_interval);
    ...
    this.draw = function(){
        var i, j, img0, img1, dx, dy, dist, max = 100, lineSegs = 50, c1ax, c1ay, c2ax, c2ay, c1x, c1y, c2x, c2y, oscFactor = 2, angleIncr = 0.05;
