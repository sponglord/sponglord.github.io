function Portfolio_4_8_1_7_s(mouseContext, aNumImages) {
    var _canvas, _context, _image, _images = [], _bezier1, _bezier2, _bezier3, _bezier4, _count = 0, _imageW = 30, _imageH = 30, _numImages = 60, _checkForCollision = true, _gotoTarget = false, _doMove = true, _imgInPlaceCount = 0, _interval, _canvasW, _canvasH;
    
    _bezier1 = {x:1, y:0, z:Math.random() / 2};
    _bezier2 = {x:0, y:1, z:Math.random() / 2};
    _bezier3 = {x:1, y:0, z:Math.random() / 2};
    _bezier4 = {x:0, y:1, z:Math.random() / 2};
...
//					
    ...
    this.draw = function()
    {
    	var i, j, img0, img1, dx, dy, dist, max = 150, lineSegs = 50, c1ax, c1ay, c2ax, c2ay, c1x, c1y, c2x, c2y, c3ax, c3ay, c4ax, c4ay, c3x, c3y, c4x, c4y, oscFactor = 4, angleIncr = 0.05;
        ...
        for(i = 0; i < _numImages - 1; i++)
	{
		...
		if(dist < max)
		{
		    _context.strokeStyle = "rgba(255,255,255, 0.4)";
