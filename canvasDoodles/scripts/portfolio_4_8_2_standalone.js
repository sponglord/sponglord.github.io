function Portfolio_4_8_2_s(mouseContext, aNumImages) {
    var _canvas, _context, _image, _images = [], _count = 0, _imageW = 30, _imageH = 30, _numImages = 4, _checkForCollision = true, _gotoTarget = false, _imgInPlaceCount = 0, _interval, _canvasW, _canvasH;
   ...
   if(mouseContext !==  undefined) {
    ...
    this.init = function()
    {
	    ...
	    if(aNumImages === undefined) this.createTilePositions(_images, 2, 2, 25, 200);
    ...
    //
    // portfolio_4_7_4
    // -- curves only, no dots - but could be better - see portfolio_4_8_3
    //
    // portfolio_4_8
...
//					
    ...
    this.draw = function()
    {
    	var i, j, img0, img1, dx, dy, dist, max = 400, lineSegs = 50, c1ax, c1ay, c2ax, c2ay, c1x, c1y, c2x, c2y, oscFactor = 2, angleIncr = 0.05;
